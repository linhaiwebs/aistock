    ...
    <div className="w-32 h-32 sm:w-40 sm:h-40 animate-rocket-lift">
      ...
      >
        ...
        <g className="rocket-main">
          <path d="M 100 30 L 85 60 L 85 130 L 115 130 L 115 60 Z" fill="url(#rocketBodyGradient)" stroke="#81E6D9" strokeWidth="2" opacity="0.9" />

          <ellipse cx="100" cy="30" rx="15" ry="20" fill="#38B2AC" stroke="#81E6D9" strokeWidth="2" opacity="0.8" />

          <circle cx="100" cy="80" r="12" fill="url(#rocketWindowGradient)" stroke="#2C5282" strokeWidth="2">
            <animate attributeName="opacity" values="1;0.6;1" dur="3s" repeatCount="indefinite" />
          </circle>

          <path d="M 70 100 L 85 100 L 85 140 Z" fill="#2C5282" stroke="#81E6D9" strokeWidth="2" opacity="0.7" />
          <path d="M 130 100 L 115 100 L 115 140 Z" fill="#2C5282" stroke="#81E6D9" strokeWidth="2" opacity="0.7" />

          <rect x="92" y="100" width="5" height="15" rx="1" fill="url(#accentGradient)" opacity="0.6" />
          <rect x="103" y="100" width="5" height="15" rx="1" fill="url(#accentGradient)" opacity="0.6" />

          <circle cx="100" cy="50" r="3" fill="#E0F7FA" opacity="0.7" />
          <circle cx="105" cy="55" r="2" fill="#E0F7FA" opacity="0.5" />
        </g>

        <g className="flames">
          <ellipse cx="93" cy="135" rx="8" ry="15" fill="url(#flameGradient)" opacity="0.7">
          ...
          <ellipse cx="100" cy="135" rx="10" ry="20" fill="url(#flameGradient)" opacity="0.8">
          ...
          <ellipse cx="107" cy="135" rx="8" ry="15" fill="url(#flameGradient)" opacity="0.7">
            <animate attributeName="ry" values="15;25;15" dur="0.35s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0.7;0.4;0.7" dur="0.35s" repeatCount="indefinite" />
          </ellipse>

          <ellipse cx="95" cy="145" rx="6" ry="12" fill="#FFD7BE" opacity="0.5">
          ...
          <ellipse cx="105" cy="145" rx="6" ry="12" fill="#FFD7BE" opacity="0.5">
        ...
        <g className="smoke-particles" opacity="0.3">
          <circle cx="85" cy="160" r="4" fill="#81E6D9">
            <animate attributeName="cy" values="160;180;160" dur="2s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0.3;0;0.3" dur="2s" repeatCount="indefinite" />
          </circle>
          <circle cx="100" cy="165" r="5" fill="#81E6D9">
            <animate attributeName="cy" values="165;190;165" dur="2.5s" repeatCount="indefinite" begin="0.3s" />
            <animate attributeName="opacity" values="0.3;0;0.3" dur="2.5s" repeatCount="indefinite" begin="0.3s" />
          </circle>
          <circle cx="115" cy="160" r="4" fill="#81E6D9">
            <animate attributeName="cy" values="160;180;160" dur="2.2s" repeatCount="indefinite" begin="0.6s" />
            <animate attributeName="opacity" values="0.3;0;0.3" dur="2.2s" repeatCount="indefinite" begin="0.6s" />
          </circle>
        </g>

        <g className="sparkles">
          <circle cx="80" cy="120" r="2" fill="#FFD7BE">
            <animate attributeName="opacity" values="0;1;0" dur="1s" repeatCount="indefinite" />
          </circle>
          <circle cx="120" cy="110" r="2" fill="#FFD7BE">
            <animate attributeName="opacity" values="0;1;0" dur="1.2s" repeatCount="indefinite" begin="0.3s" />
          </circle>
          <circle cx="95" cy="90" r="1.5" fill="#4FD1C5">
