  ...
  return (
    <div className="text-center animate-fadeIn relative -mt-12 md:-mt-16">
      ...
      <div className="relative -mt-24 z-30">
        <div className="inline-block bg-gradient-to-r from-cyan-500 to-blue-600 text-text-primary text-sm font-bold px-4 py-2 rounded-full mb-3 shadow-soft-shadow-lg animate-pulse">
          完全無料 • アカウント不要 • 即座に開始
        </div>
        ...
        <p className="text-xs md:text-sm text-cyan-200/90 mt-2 drop-shadow-soft-shadow-lg">
          高速処理 • 利用制限なし • データ保護
        </p>
      </div>
    </div>
