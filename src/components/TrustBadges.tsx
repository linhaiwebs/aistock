    ...
    <div className="w-full max-w-md mx-auto px-4 mb-6">
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-600/20 backdrop-blur-md border border-cyan-400/40 rounded-lg p-3 text-center">
          ...
          <p className="text-xs font-bold text-cyan-100 drop-shadow-soft-shadow-lg">完全無料</p>
          <p className="text-[10px] text-cyan-200/80 drop-shadow-soft-shadow-lg">永久無料提供</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-blue-700/20 backdrop-blur-md border border-blue-400/40 rounded-lg p-3 text-center">
          ...
          <p className="text-xs font-bold text-blue-100 drop-shadow-soft-shadow-lg">安全保護</p>
          <p className="text-[10px] text-blue-200/80 drop-shadow-soft-shadow-lg">データ暗号化</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-teal-500/20 to-teal-600/20 backdrop-blur-md border border-teal-400/40 rounded-lg p-3 text-center">
          ...
          <p className="text-xs font-bold text-teal-100 drop-shadow-soft-shadow-lg">即時分析</p>
          <p className="text-[10px] text-teal-200/80 drop-shadow-soft-shadow-lg">数秒で完了</p>
        </div>
